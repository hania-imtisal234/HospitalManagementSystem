...
from django.urls import path
from .views import admin_dashboard, create_update_doctor_view, create_update_patient_view, delete_doctor_view, delete_patient_view, doctor_detail_view, doctor_list_view, patient_detail_view, patient_list_view, user_login, doctor_dashboard, user_logout
